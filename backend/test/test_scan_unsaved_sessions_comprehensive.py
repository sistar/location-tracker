    ...
    def test_clean_phantom_locations_stopped_points(self):
        ...
        for i in range(25):  # Need enough points for median calculation
            locations.append({
                ...
                'timestamp': base_timestamp + (i * 30)  # 30 second intervals for 12.5 minutes total
            })
...
class TestHandler:
    ...
    def test_handler_invalid_days_parameter(self):
        ...
        with patch('handlers.scan_unsaved_sessions.fetch_vehicle_locations') as mock_fetch:
...
class TestSessionDetectionLogic:
    ...
    def test_minimum_session_requirements(self, mock_fetch_locations):
        ...
        locations = [
            ...
            {
                'id': 'vehicle_01',
                'timestamp': int((now + timedelta(minutes=2)).timestamp()),  # Very short
