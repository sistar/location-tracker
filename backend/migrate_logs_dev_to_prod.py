#!/usr/bin/env python3
"""
Script to migrate driver logs data from dev to prod DynamoDB tables.
Copies data from gps-tracking-service-dev-locations-logs-v2 to gps-tracking-service-prod-locations-logs-v2
"""
...
# Table names
SOURCE_TABLE = "gps-tracking-service-dev-locations-logs-v2"
TARGET_TABLE = "gps-tracking-service-prod-locations-logs-v2"
...
if __name__ == "__main__":
    print("DynamoDB Driver Logs Migration Script")
    print("=" * 50)
    ...
    print(f"\nCopying ALL driver logs data from:")
    ...
    if success:
        print("\n✅ Driver logs migration completed successfully!")
    else:
        print("\n❌ Driver logs migration failed!")
        exit(1)