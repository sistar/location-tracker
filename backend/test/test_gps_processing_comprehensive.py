...
class TestIntegrationScenarios:
    ...
    def test_realistic_driving_scenario(self):
        ...
        locations = [
            ...
            {'lat': 52.5250, 'lon': 13.4100, 'time': '2023-04-14T12:01:00Z'},  # 1 min later
            {'lat': 52.5300, 'lon': 13.4150, 'time': '2023-04-14T12:02:00Z'},  # 2 min later
            {'lat': 52.5350, 'lon': 13.4200, 'time': '2023-04-14T12:03:00Z'},  # 3 min later
        ]
    ...
    def test_gps_glitch_scenario(self):
        ...
        locations = [
            ...
            {'lat': 55.7558, 'lon': 37.6176, 'time': '2023-04-14T12:01:01Z'},  # Glitch: Moscow!
            {'lat': 52.5300, 'lon': 13.4150, 'time': '2023-04-14T12:02:00Z'},  # Back to normal
        ]
